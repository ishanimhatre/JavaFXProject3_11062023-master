...
//    public void printSorted(TextArea outputArea5) {
//        if (numAcct == 0) {
//            outputArea5.appendText("Account Database is empty!\n");
//        } else {
//            // Sort the accounts using bubble sort
//            outputArea5.appendText("\n*Accounts sorted by account type and profile.\n");
//            bubbleSort();
//            for (int i = 0; i < numAcct; i++) {
//                outputArea5.appendText(accounts[i].toString() + "\n");
//            }
//            outputArea5.appendText("*end of list.\n");
//        }
//    }
    ...
    public void handlePrintAccountsClick(ActionEvent event) {
        ...
        outputArea4.appendText(sortedAccounts);
    }


    @FXML
    public void handleInterestAndFeesClick(ActionEvent event){
        StringBuilder printIF = accountDatabase.printFeesAndInterests();
        outputArea4.appendText(String.valueOf(printIF));

    }

    @FXML
    public void handleUpdateAccountsClick(ActionEvent event){
        StringBuilder printUB = accountDatabase.printUpdatedBalances();
        outputArea4.appendText(String.valueOf(printUB));
    }
